...
ALTER TABLE `db_geseld`.`t_document` ADD COLUMN `ACTIF` BOOLEAN NOT NULL DEFAULT 0 AFTER `DATE_HEURE_STATUT_DOCUMENT`;

ALTER TABLE `db_geseld`.`t_type_document` ADD COLUMN `ACTIF` BOOLEAN NOT NULL DEFAULT 0 AFTER `CODE_TYPE_DOCUMENT`;
